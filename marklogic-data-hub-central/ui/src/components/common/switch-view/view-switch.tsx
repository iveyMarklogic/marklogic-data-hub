      ...
      {loadTile ? (
        <div className={"switch-button-group outline"}>
          <span>
            ...
            />
            <label
              aria-label="switch-view-card"
              htmlFor="switch-view-card"
              className={`${className} ${styles.leftButton}`}
          ...
          <span>
            ...
            <HCTooltip text="List View" id="list-view-tooltip" placement="top">
              <label
                aria-label="switch-view-list"
                htmlFor="switch-view-list"
                className={`${className} ${styles.rightButton}`}
                id={"listView"}
                style={style}
              >
        ...
        <div className={"switch-button-group outline"}>
          ...
          >
            ...
            <HCTooltip text="Graph View" id="graph-view-tooltip" placement="top">
              <label
                aria-label="switch-view-graph"
                htmlFor="switch-view-graph"
                className={`${className} ${styles.leftButton}`}
                id={"graphView"}
                style={style}
              >
          ...
          >
            ...
            <HCTooltip text="Table View" id="table-view-tooltip" placement="top">
              <label
                aria-label="switch-view-table"
                htmlFor="switch-view-table"
                className={`${className} ${!snippetView && styles.rightButton}`}
                id={"tableView"}
                style={style}
              >
          ...
          {snippetView && (
            <span
              ...
              onKeyDown={event => {
                if (event.key === "Enter" || event.key === " ") {
                  handleViewChange(ViewType.snippet);
                }
              }}
            >
              <input
              ...
              <HCTooltip text="Snippet View" id="snippet-view-tooltip" placement="top">
                <label
                  aria-label="switch-view-snippet"
                  htmlFor="switch-view-snippet"
                  className={`${className} ${styles.rightButton}`}
                  id={"snippetView"}
                  style={style}
                >
